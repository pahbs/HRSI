...
##def plotFig (image_dir, figName, plot_dimx, plot_dimy):
##    fig = matplotlib.pyplot.gcf()
##    fig.set_size_inches(plot_dimx,plot_dimy)
##    matplotlib.pyplot.savefig(os.path.join(image_dir,figName + '.png'), dpi=250, bbox_inches='tight', pad_inches=0.1)
##    Image.open(os.path.join(image_dir,figName + '.png')).save(os.path.join(image_dir,figName + '.jpg'),'JPEG')
##    os.remove(os.path.join(image_dir,figName+'.png'))
"""
--- FUNCTIONS
"""
...
##        fit_GMM(masked_array, plotdir, inRaster, 3)
...
def run_hist_subsets(image_dir,searchStr, ncomp, sampleStep, tail, doRasSub=False):      ##WV01_20100819_102001000E7B0000_102001000F95F800/VHRhist_in/'
    """
...
if __name__ == "__main__":
    import sys
    run_hist_subsets(str(sys.argv[1]),str(sys.argv[2]), int(sys.argv[3]),float(sys.argv[4]), str(sys.argv[5]))